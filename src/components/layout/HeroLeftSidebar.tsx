  ...
  return (
    <div className="relative overflow-hidden bg-[#2d0a20]/95 backdrop-blur-xl border border-pink-900/60 rounded-3xl p-4 shadow-xl flex flex-col justify-between min-h-[260px] group text-white">
      ...
      <div className="space-y-3">
        {/* Header Title */}
        <div className="flex items-center justify-between pb-1.5 border-b border-pink-900/40">
        ...
        {/* Video Player */}
        <div className="relative aspect-video w-full rounded-2xl overflow-hidden bg-slate-950 border border-pink-900/50 shadow-inner group/player">
        ...
        <div className="space-y-1">
          ...
          <p className="text-[10px] leading-relaxed text-pink-100/90 line-clamp-2 pt-1 border-t border-pink-900/40 italic">
...
export function LiveUpdatesWidget({ updates }: { updates: LiveUpdate[] }) {
  ...
  return (
    <div className="relative overflow-hidden bg-[#2d0a20]/95 backdrop-blur-xl border border-pink-900/60 rounded-3xl p-4 shadow-xl flex flex-col justify-between min-h-[290px] group text-white">
