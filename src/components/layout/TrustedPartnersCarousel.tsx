...
export default function TrustedPartnersCarousel() {
  ...
  return (
    <section className="py-20 bg-pink-50/30 border-t border-b border-pink-100 overflow-hidden relative">
        ...
        <div className="animate-partner-marquee flex gap-6 px-4">
          {duplicatedPartners.map((partner, idx) => (
            <a
              ...
              className="group relative flex-shrink-0 w-72 sm:w-80 bg-white rounded-2xl p-5 border border-pink-100 shadow-sm hover:shadow-xl hover:border-pink-300 hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between cursor-pointer"
            >
              {/* External Link Icon indicator on hover */}
              <div className="absolute top-3.5 right-3.5 opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-pink-600">
                <ExternalLink className="h-4 w-4" />
              </div>

              {/* Logo Area with Grayscale to Color Transition */}
              <div className="h-20 w-full flex items-center justify-center p-2 mb-3 bg-pink-50/40 rounded-xl border border-pink-100">
                <img
                  src={partner.logo}
              ...
              <div className="space-y-2 text-left">
                ...
                <h3 className="text-sm font-bold text-slate-900 group-hover:text-pink-600 transition-colors line-clamp-1">
                  {partner.name}
                </h3>
              </div>
            </a>
