        ...
        <nav className="hidden lg:flex items-center gap-3 lg:gap-5 xl:gap-7 absolute left-1/2 -translate-x-1/2 z-0">
          {isCampaignPage ? (
            ...
            <>
              ...
              {/* Donate Link Styled as Button with Pink Theme */}
          ...
          <div className="hidden lg:flex items-center gap-4">
            {user ? (
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-56 bg-white border-pink-100 text-slate-800 shadow-xl shadow-pink-900/10" align="end">
                  <DropdownMenuGroup>
                  ...
                  <DropdownMenuSeparator className="bg-pink-100" />
                  <DropdownMenuItem className="hover:bg-pink-50 focus:bg-pink-50 cursor-pointer text-destructive focus:text-destructive">
                    <form action={handleSignOut} className="w-full m-0 p-0">
                      <button className="w-full text-left font-medium cursor-pointer border-0 bg-transparent p-0 m-0 text-sm text-rose-600" type="submit">
                        Sign Out
                      </button>
                    </form>
                  </DropdownMenuItem>
              ...
              <>
                <Link href="/login">
                  <Button variant="ghost" size="sm" className="text-slate-700 hover:text-pink-600 hover:bg-pink-50 h-10 px-4 font-semibold uppercase tracking-wider text-xs">
                    Login
                  </Button>
                </Link>
                {isCampaignPage ? (
                  <Link href="/register">
                    <Button variant="outline" size="sm" className="border-pink-300 text-slate-700 hover:bg-pink-50 h-10 px-4 font-semibold uppercase tracking-wider text-xs bg-transparent">
                      Register
                    </Button>
                  </Link>
                ) : (
                  <Link href="/register">
                    <Button size="sm" className="bg-primary hover:bg-primary/95 text-white font-bold shadow-md shadow-pink-600/20 transition-transform active:scale-95 h-10 px-4">
                      Get Started
                    </Button>
                  </Link>
                )}
