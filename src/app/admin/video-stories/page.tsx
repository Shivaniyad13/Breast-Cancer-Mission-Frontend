  ...
  return (
    <div className="container mx-auto px-4 py-8 sm:px-6 lg:px-8 space-y-8 min-h-screen">
      ...
      <div className="flex gap-4 border-b border-slate-100 pb-4 text-sm font-semibold overflow-x-auto no-scrollbar whitespace-nowrap">
        ...
        <Link href="/admin/gallery" className="text-slate-500 hover:text-primary transition-colors">
          Event Gallery
        </Link>
        <Link href="/admin/video-stories" className="text-primary border-b-2 border-primary pb-4 -mb-[18px] transition-colors">
          Video Stories
        </Link>
      </div>
